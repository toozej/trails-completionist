// Package man provides manual page generation functionality for the trails-completionist application.
//
// This package creates Unix manual pages (man pages) for the trails-completionist CLI
...
// Example usage:
//
//	import "github.com/toozej/trails-completionist/pkg/man"
//
//	// Add man command to root command
//	rootCmd.AddCommand(man.NewManCmd())
//
//	// Generate man pages:
//	// ./trails-completionist man > trails-completionist.1
package man
...
// for the trails-completionist application. The command traverses the root command tree
...
//	// ./trails-completionist man > trails-completionist.1
//	// man ./trails-completionist.1
func NewManCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:                   "man",
		Short:                 "Generates trails-completionist's command line manpages",
		SilenceUsage:          true,
